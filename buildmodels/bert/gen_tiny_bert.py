...
# 3. Export to ONNX
# -------------------------------
onnx_path = "buildmodels/bert/bert_tiny.onnx"
torch.onnx.export(
    model,
    flat_input,
    onnx_path,
    ...
    #                             'output': {0: 'batch_size'}})   
    dynamic_axes=None          # 🚫 no dynamic axes (fixed shape 1x(3*seq_len))    
)
...
with open("buildmodels/bert/bert_tiny_input.json", "w") as f:
